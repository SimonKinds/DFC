...
void DF_TwoByte_Indexer(benchmark::State& state) {
...
void DF_FourByteHash_Indexer(benchmark::State& state) {
...
void CT_Small_Indexer(benchmark::State& state) {
...
void CT_Large_Indexer(benchmark::State& state) {
